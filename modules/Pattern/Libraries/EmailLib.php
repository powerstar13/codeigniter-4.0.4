...
class EmailLib
{
    ...
    private $senderName = 'MasterHong'; // 발신자 이름 (생략가능)
    private $email;
    ...
    {
        $imagePath = 'http://ionline-dev.kai-i.com/images/common/ic-mini.png'; // 삽입할 이미지의 절대경로 (서버에 올라간 경로만 가능함)
        if (is_https()) {
            $imagePath = 'https://ionline.kai-i.com/images/common/ic-mini.png'; // 실서버 이미지 경로
        }
